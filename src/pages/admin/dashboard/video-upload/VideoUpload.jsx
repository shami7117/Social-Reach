...
const VideoUpload = () => {
    ...
    return (
        <div>
            <AdminLayout>
                <div className="flex flex-col gap-y-10 bg-[#EFF6F9] md:pt-20 md:pb-40 py-10 px-5 md:py-20  md:px-20  items-start justify-start w-full">
                    <div
                        className="flex flex-col text-black justify-start items-start gap-3 w-full  bg-white  rounded-md  px-5 md:px-10 py-6"
                    ...
                    >
                        <div className="flex justify-between items-center w-full">
                            <div className="flex items-center text-black gap-3">
                                <CiImageOn size={35} />
                                <p className="text-[25px] font-[500]">Videos</p>
                            </div>
                        ...
                        <div className=''>
                            ...
                            <p onClick={showModal4} className='flex mt-5 justify-center items-center rounded-md border w-[150px] h-[150px] overflow-hidden ' >
                                <iframe width="120" height="120" src="https://www.youtube.com/embed/IXFX8Snp_GU?si=shU8QPK7sXRdAul6&amp;start=20" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

                            </p>
                            <div>
                                {/* put Videos here that uploaded  */}
                            </div>
                ...
                >
                    <div className="bg-[#012B6D] w-[328px] md:w-[700px] rounded-t-md p-5 ml-[-1.5rem] mt-[-1.3rem]">
                        <h1 className="text-[25px] text-white">View Video</h1>
                    </div>
                    <div className='my-10 text-[#4A4A4A] flex flex-col justify-center items-center w-full'>
                        ...
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/IXFX8Snp_GU?si=E_cCSRvOmA_DWNED&amp;start=20" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                        <div className="flex items-center gap-6 justify-center  mt-5 ">
                ...
                >
                    <div className="bg-[#012B6D] w-[328px] md:w-[700px] rounded-t-md p-5 ml-[-1.5rem] mt-[-1.3rem]">
                        <h1 className="text-[25px] text-white">Upload Videos</h1>
                    </div>
                    <div className='my-10'>
                        <Upload2 />
