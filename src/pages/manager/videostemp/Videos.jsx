...
import { BsFolderSymlink, BsImageAlt } from 'react-icons/bs'
import { RiDeleteBinLine } from 'react-icons/ri'
import Upload2 from '../imagegallery/Upload'
import ManagerLayout from '../../../components/layout/ManagerLayout'
const VideosManagerTeam = () => {
                ...
                <div className="flex flex-col gap-y-10 items-start justify-start w-full">
                    ...
                    >
                        ...
                        <div className=''>
                            ...
                            <div className='flex mt-5 justify-center items-center rounded-md border w-[120px] h-[120px]'>
                                <div className='w-[110px] h-[110px] rounded-md flex justify-center items-center bg-gray-300'>
                                    <BsImageAlt size={35} className='text-gray-400' />
                                </div>
                            </div>
                            <div>
...
export default VideosManagerTeam