    ...
    return (
        <AdminLayout>
            <div className='flex flex-col gap-y-10 bg-[#EFF6F9] md:pt-20 md:pb-40 py-10 px-5 md:py-20  md:px-20  items-start justify-start w-full'>
                <div className='flex flex-col justify-start items-start gap-3 w-full text-black bg-white rounded-md px-5 md:px-10 py-6' style={{ boxShadow: "0px 4px 4px 0px rgba(0, 0, 0, 0.25)" }}>
